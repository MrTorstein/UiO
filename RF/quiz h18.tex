...
%
%
% Torstein sine forslag
%
% \item \textbf{Riktige alternativer} \vspace{1mm}
%	\textit{Ingen brukte}
%		\begin{enumerate}
% \item En gjest som danset ballet på dansegulvet i foajeen, og som fortsatte da gulvet begynte å fylle seg opp så han til slutt ble skjøvet bort til under tv-skjermen til biblioteket
% \item 
%		\end{enumerate}	
%
%
%	\item \textbf{Falske alternativer} \vspace{1mm}
%	\textit{Noen brukt, noen ubrukt}
%		\begin{enumerate}
% \item En gjest som ble kastet ut fordi han spyttet skråtobakk i veska til en annen gjest (Brukt)
% \item Gjest som ble funnet mens han satt og dreit oppi pissoaret
% \item Noen som ble stoppet i døra fordi de hadde med seg en bensinkanne med innhold (Brukt)
% \item At DJ-boden måtte stenges fordi alle DJene var kastet ut for å være for fulle (Brukt)
% \item Noen hadde sex i heisen mens den gikk opp og ned mellom første og tredje etasje (Brukt)
% \item En gjest med killer clown kostymet med faktisk kjøkkenkniv prøvde å komme seg inn på Halloween
% \item Gjest klaget på at det spøker(på toalettet?) (Brukt)
% \item Skjedde så lite på jobb en dag at en vakt ødela en av de mekaniske tellerene ved å se hvor fort hun kunne trykke
% \item En Gjest som prøvde å røyke vannpipe sammen med vennene sinde i en bås i kjellern
% \item En gjest som ble så sur etter å ha tapt quizen at han stormer ut av kjellern mens han skjelder ut alle som jobbet den dagen
% \item Gjest som var i så godt humør at han skulle ha en klem av alle vaktene før han ville gå hjem fra semesterstart
%		\end{enumerate}	
\end{document}